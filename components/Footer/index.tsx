        ...
        <div className="container">
              ...
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    ...
                    src="/images/logo/Skyhunch-logos_black_compact.png"
                    alt="logo"
                  ...
                  <Image
                    ...
                    src="/images/logo/Skyhunch-logos_transparent_compact.png"
                    alt="logo"
                ...
                <div className="flex items-center">
                  ...
                  {/* Twitter Link */}
                  <a
                    href="https://twitter.com/Skyhunch_tech"
                    aria-label="social-link"
                    className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  >
                    <svg
                  ...
                  {/* Linkedin link */}
                  <a
                    href="https://www.linkedin.com/company/skyhunch"
                    aria-label="social-link"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright &copy; 2024,{" "}
              <a href="https://skyhunch.com" rel="nofollow noopener">
                skyhunch.com
              </a>
              {", "}All Rights Reserved.
            </p>
